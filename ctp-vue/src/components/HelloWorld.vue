          ...
          <li class="nav-header">
            <div class="dropdown profile-element">
              ...
              <ul class="dropdown-menu animated fadeInRight m-t-xs">
                ...
                <li><router-link :to="{ name : 'Login' }">Logout</router-link></li>
              </ul>
            </div>
                  ...
                  <div class="ibox-content">
                    ...
                    <div>
                      <div class="feed-activity-list">
                        ...
                        <div class="feed-element">
                          <a class="float-left" href="profile.html">
                            <img alt="image" class="rounded-circle" src="../assets/img/a2.jpg">
                          </a>
                          <div class="media-body ">
                        ...
                        <div class="feed-element">
                          <a class="float-left" href="profile.html">
                            <img alt="image" class="rounded-circle" src="../assets/img/a3.jpg">
                          </a>
                          <div class="media-body ">
                            <small class="float-right">2h ago</small>
                        ...
                        <div class="feed-element">
                          <a class="float-left" href="profile.html">
                            <img alt="image" class="rounded-circle" src="../assets/img/a5.jpg">
                          </a>
                          <div class="media-body ">
                            <small class="float-right">2h ago</small>
